...
from app.game.sessions.service import (
    ...
    friend_challenges_create_rematch,
)
...
async def test_create_friend_challenge_rematch_creates_duel_and_emits_events(
    ...
    result = await friend_challenges_create_rematch.create_friend_challenge_rematch(
        _Session(),
    ...
    assert analytics_calls == [
        {
            ...
            "opponent_user_id": 101,
            "happened_at": NOW_UTC,
            "source": friend_challenges_create_rematch.EVENT_SOURCE_BOT,
            "initiator_user_id": 202,
        }
    ]
