...
from app.game.sessions.service import (
    friend_challenges_create_rematch_draft,
...
async def test_build_rematch_friend_challenge_draft_uses_series_state_and_seed_state(
    ...
    draft = await friend_challenges_create_rematch_draft.build_rematch_friend_challenge_draft(
        _Session(),
        challenge=challenge,
    ...
    assert draft == friend_challenges_create_rematch_draft.FriendChallengeCreationDraft(
        challenge_id=CHALLENGE_ID,
        creator_user_id=202,
        opponent_user_id=101,
