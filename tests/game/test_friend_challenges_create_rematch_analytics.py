...
from app.game.sessions.service import friend_challenges_create_rematch_analytics
...
async def test_emit_rematch_duel_created_events_emits_expected_payloads(
    ...
    monkeypatch.setattr(
        friend_challenges_create_rematch_analytics,
        "emit_analytics_event",
        _fake_emit_analytics_event,
    )

    await friend_challenges_create_rematch_analytics.emit_rematch_duel_created_events(
        _Session(),
