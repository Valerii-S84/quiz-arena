...
from app.game.sessions.service import friend_challenges_round_start_question_state
...
@pytest.mark.asyncio
async def test_load_round_question_state_reuses_shared_round_question(
    ...
    monkeypatch.setattr(
        friend_challenges_round_start_question_state.QuizSessionsRepo,
...
@pytest.mark.asyncio
async def test_load_round_question_state_uses_planned_question_ids_before_selection(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
@pytest.mark.asyncio
async def test_load_round_question_state_selects_question_from_history_when_needed(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
