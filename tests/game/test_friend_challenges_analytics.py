...
from app.game.sessions.service import friend_challenges_analytics
...
async def test_emit_series_started_duel_created_events_emits_expected_payloads(
    ...
    monkeypatch.setattr(
        friend_challenges_analytics, "emit_analytics_event", _fake_emit_analytics_event
    )

    await friend_challenges_analytics.emit_series_started_duel_created_events(
        _Session(),
        duel=duel,
...
async def test_emit_series_next_game_created_events_emits_expected_payloads(
    ...
    await friend_challenges_analytics.emit_series_next_game_created_events(
        _Session(),
        duel=duel,
        source_challenge_id=SOURCE_CHALLENGE_ID,
