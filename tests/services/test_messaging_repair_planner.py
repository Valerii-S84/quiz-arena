...
def test_repair_plan_matches_current_digest_edit_and_fallback_targets() -> None:
    expected_target = "1:phase:round:2:status:round_2:edit:902"
    for delivered_target in (
        "1:phase:round:2:status:round_2:c:abc123:edit:101",
        "1:phase:round:2:status:round_2:fallback_send_after_edit:101",
    ):
        plan = build_messaging_repair_plan(
            flow="private_tournament_round_messaging",
            correlation_id="tournament-1",
