...
@pytest.mark.asyncio
async def test_production_invariant_alert_task_records_durable_alerts(
...
def test_production_invariant_alert_task_wrapper(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    result = production_invariant_alerts.run_production_invariant_alerts()
...
def test_production_invariant_alert_schedule_registered() -> None:
