...
def _daily_upsert() -> AnalyticsDailyUpsert:
    return AnalyticsDailyUpsert(
        ...
        duel_menu_opened_events_total=1,
        duel_mode_selected_events_total=2,
        arena_opened_events_total=3,
        arena_duel_created_events_total=4,
        arena_duel_started_events_total=5,
        arena_duel_completed_events_total=6,
        arena_duel_published_events_total=7,
        arena_duel_accepted_events_total=8,
        arena_result_shown_events_total=9,
        arena_result_beaten_notification_sent_events_total=10,
        arena_revanche_clicked_events_total=11,
        friend_duel_opened_events_total=12,
        friend_duel_created_events_total=13,
        friend_duel_share_clicked_events_total=14,
        friend_duel_joined_events_total=15,
        friend_duel_started_events_total=16,
        friend_duel_completed_events_total=17,
        friend_duel_published_to_arena_events_total=18,
        friend_duel_revanche_clicked_events_total=19,
        duel_limit_hit_events_total=20,
        duel_paywall_shown_events_total=21,
        duel_ticket_clicked_events_total=22,
        premium_week_clicked_events_total=23,
