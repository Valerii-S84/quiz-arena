...
async def test_completed_tournament_match_uses_tournament_keyboard_without_rematch(
    ...
    async def _fake_resolve_tournament_view_callback_data_for_match(
        *,
        session_local,
        tournament_match_id,
    ):
    ...
    monkeypatch.setattr(
        ...
        _fake_resolve_tournament_view_callback_data_for_match,
    )
    monkeypatch.setattr(
        friend_answer_completion_flow,
...
@pytest.mark.asyncio
async def test_completed_daily_cup_match_uses_daily_cup_view_callback(monkeypatch) -> None:
    tournament_id = "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"
