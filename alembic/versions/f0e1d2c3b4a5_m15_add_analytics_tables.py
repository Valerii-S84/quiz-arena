...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_analytics_events_type_time", "analytics_events", ["event_type", "happened_at"]
    )
    op.create_index(
        "idx_analytics_events_user_time", "analytics_events", ["user_id", "happened_at"]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "purchases_credited_total", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        ...
        sa.Column(
            "promo_redemptions_total", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
        ...
        sa.Column(
            "promo_redemption_rate", sa.Numeric(8, 6), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
        ...
        sa.Column(
            "quiz_sessions_started_total", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
        ...
        sa.Column(
            "gameplay_completion_rate",
            sa.Numeric(8, 6),
            nullable=False,
            server_default=sa.text("0"),
        ),
        sa.Column(
            "energy_zero_events_total", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "streak_lost_events_total", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
        ...
        sa.Column(
            "referral_reward_granted_events_total",
            sa.Integer(),
            nullable=False,
            server_default=sa.text("0"),
        ),
        ...
        sa.CheckConstraint(
            "purchasers_total >= 0", name="ck_analytics_daily_purchasers_non_negative"
        ),
        sa.CheckConstraint(
