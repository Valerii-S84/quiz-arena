...
<!-- bundle: agent-rules | version: 1.1.0 -->
...
[ ] .agent/core/TASK_DISCIPLINE.md існує
...
**Відповідність вимогам bundle: __ / 82**

| Діапазон | Висновок |
|---|---|
| 73–82 | Повна відповідність. Агент може стартувати. |
| 61–72 | Часткова відповідність. Є gap-и, але не блокери. |
| < 61 | Критичні прогалини. Заповни перед стартом. |
...
Якщо жоден блокер не активований і оцінка ≥ 73 — агент може починати роботу.
