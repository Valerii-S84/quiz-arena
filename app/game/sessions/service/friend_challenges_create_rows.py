...
from .friend_challenges_create_drafts import FriendChallengeCreationDraft
from .friend_challenges_records import _create_friend_challenge_row


async def create_friend_challenge_from_draft(
    session: AsyncSession,
    *,
    draft: FriendChallengeCreationDraft,
    now_utc: datetime,
) -> FriendChallenge:
