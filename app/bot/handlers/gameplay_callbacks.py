...
FRIEND_ONBOARDING_SHOW_RE = re.compile(r"^friend:onboarding:show:([0-9a-f\-]{36})$")
FRIEND_ONBOARDING_INFO_RE = re.compile(r"^friend:onboarding:info:([0-9a-f\-]{36})$")
FRIEND_FINISHED_SHOW_RE = re.compile(r"^friend:finished:show:([0-9a-f\-]{36})$")
FRIEND_FINISHED_INFO_RE = re.compile(r"^friend:finished:info:([0-9a-f\-]{36})$")
