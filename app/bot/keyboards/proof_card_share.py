...
FRIEND_CHALLENGE_INVITE_INLINE_SHARE_PREFIX = "invite:duel:"
...
def build_friend_challenge_invite_inline_share_query(*, challenge_id: str) -> str:
    return f"{FRIEND_CHALLENGE_INVITE_INLINE_SHARE_PREFIX}{challenge_id}"
