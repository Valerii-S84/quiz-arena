PROMO_TEXTS_DE: dict[str, str] = {
    ...
    "msg.promo.success.grant.details": "Aktiviert: {premium_days} Tage Arena Pass bis {premium_ends_at} (Berlin).",
    "msg.promo.success.discount": "✅ Promo-Code aktiviert.",
    "msg.promo.success.discount.details": "Aktiviert: {discount_label} für {scope_label} bis {reserved_until} (Berlin).",
    "msg.promo.discount.unavailable": "⚠️ Das Promo-Angebot ist derzeit nicht verfügbar.",
