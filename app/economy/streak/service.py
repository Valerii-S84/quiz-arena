...
from app.core.global_best_streak_cache import schedule_global_best_streak_update_after_commit
    ...
    async def record_activity(
        ...
        *,
        ...
        if snapshot.best_streak > snapshot_before_rollover.best_streak:
            schedule_global_best_streak_update_after_commit(session, snapshot.best_streak)
