...
from sqlalchemy import BigInteger, CheckConstraint, Date, DateTime, ForeignKey, Index, Integer, SmallInteger
...
class EnergyState(Base):
    ...
    __table_args__ = (
        CheckConstraint("free_energy >= 0 AND free_energy <= 20", name="ck_energy_state_free_energy_range"),
