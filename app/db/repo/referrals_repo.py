...
from app.db.repo.referrals_mutations import (  # noqa: F401
    create,
    mark_started_as_rejected_fraud,
)
...
class ReferralsRepo:
    ...
    list_referrer_ids_with_reward_candidates = staticmethod(list_referrer_ids_with_reward_candidates)
