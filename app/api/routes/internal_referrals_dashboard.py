...
from .internal_referrals_models import (
    ...
    ReferralDashboardThresholdsResponse,
    ReferralFraudCaseResponse,
    ReferralTopReferrerStatsResponse,
)
...
async def get_referrals_dashboard(
    *,
    ...
    top_referrers = [
        ReferralTopReferrerStatsResponse(**row)  # type: ignore[arg-type]
        for row in snapshot.top_referrers
    ]
    recent_fraud_cases = [
        ReferralFraudCaseResponse(**row)  # type: ignore[arg-type]
        for row in snapshot.recent_fraud_cases
    ]
