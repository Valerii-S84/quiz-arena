...
def is_honeypot_triggered(payload: ContactPayload) -> bool:
...
def validate_contact_payload(payload: ContactPayload) -> None:
...
def normalize_contact_payload(payload: ContactPayload) -> dict[str, object]:
