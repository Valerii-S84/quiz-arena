...
## Scope
- Split `app/workers/tasks/payments_reliability.py` into single-responsibility modules with the same API and behavior.
- Facade `app/workers/tasks/payments_reliability.py` preserves import path and task names.
