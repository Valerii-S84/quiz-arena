...
## Scope
- Split `app/db/repo/promo_repo.py` into single-responsibility modules with the same API and behavior.
- Facade `app/db/repo/promo_repo.py` preserves import path and public API.
