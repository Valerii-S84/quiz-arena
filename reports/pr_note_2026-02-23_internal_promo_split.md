...
## Scope
- Split `app/api/routes/internal_promo.py` into single-responsibility modules with the same API and behavior.
- Facade `app/api/routes/internal_promo.py` preserves import path and request signatures.
