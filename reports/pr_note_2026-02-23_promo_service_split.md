...
## Scope
- Split `app/economy/promo/service.py` into single-responsibility modules with the same API and behavior.
- Facade `app/economy/promo/service.py` preserves import path and public API.
