...
## Scope
- Split `app/workers/tasks/friend_challenges.py` into single-responsibility modules with the same API and behavior.
- Facade `app/workers/tasks/friend_challenges.py` preserves import path and task name.
