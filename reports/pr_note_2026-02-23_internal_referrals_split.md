...
## Scope
- Split `app/api/routes/internal_referrals.py` into single-responsibility modules with the same API and behavior.
- Facade `app/api/routes/internal_referrals.py` preserves import path and request signatures.
