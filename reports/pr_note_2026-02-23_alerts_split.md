...
## Scope
- Split `app/services/alerts.py` into single-responsibility modules with the same API and behavior.
- Facade `app/services/alerts.py` preserves import path and public API.
